...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': BASE_DIR / 'logs/dashboard.log',  # Adjust path if needed
            'formatter': 'verbose',
        },
        'console': {
            'level': 'DEBUG',
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    BASE_DIR / 'shop/templates/shop/static',  # Path to your static directory
    BASE_DIR / 'shop/templates/admin',  # Path to your static directory
]
